...
import {
  Home, Upload, FileCheck2, MapPin, Settings, UserRound, LogOut, ShieldAlert, SlidersHorizontal} from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { href: "/admin/location-details", label: "Location Details", icon: Settings },
    { href: "/admin/classifier", label: "Classifier", icon: SlidersHorizontal },
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="md:hidden sticky top-0 z-20 border-b bg-background/80 backdrop-blur">
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="font-semibold">Difotoin â€” Admin</div>
          <div className="flex items-center gap-2">
            <button onClick={logout} className="p-2 rounded-lg border" aria-label="Logout">
          ...
          <div className="sticky top-4 rounded-2xl border">
            ...
            <nav className="p-2">
              ...
              <div className="px-3 py-2">
                <button
                  onClick={logout}
                  className="w-full h-9 rounded-xl border text-sm flex items-center justify-center gap-2"
                >
                  <LogOut className="h-4 w-4" />
                  <span>Logout</span>
                </button>
